<?php
class Modelo_Cena extends CI_Model {
	private $tabla;
	private $prefijo;
	...
	public function getLastId(){
		$this->db->select_max("id_cena","maximo");
    ...
    public function eliminar($codigo){
    	$this->db->where('id_cena', $codigo);
		$this->db->delete($this->tabla);
    }

    public function obtenerCena($nombre_cena){
    	$this->db->select('*');
    	$this->db->from($this->tabla);
    	$this->db->like('receta_nombre',$nombre_cena);
    	$result = $this->db->get();
