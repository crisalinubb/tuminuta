<div class="page-header">
  <div class="row">
    ...
    <div class="col-md-3" style="margin-top:24px;">
        <form class="form-inline" method="get" action="<?php echo base_url(); ?>usuarios_organizacion/busqueda">
    ...
    <div class="col-md-2" style=" margin:24px 0 10px;">
      <div class="text-center new">
        <button onclick="javascript:location.href='<?php echo base_url(); ?>usuarios_organizacion/agregar/'" type="button" class="btn btn-primary col-md-12">Agregar</button>
      </div>
    </div>
  </div>
</div>
    ...
    <tbody class="table-hover">
		<?php if($datos){ ?>
          ...
          <td><?php echo $hospital->hos_nombre; ?></td>
					<td class="editar">
						<a href="<?php echo base_url(); ?>usuarios_organizacion/editar/<?php echo $usuarios->id_usuario; ?>">
            ...
            <a href="<?php echo base_url(); ?>usuarios_organizacion/eliminar/<?php echo $usuarios->id_usuario; ?>" onclick="return confirm('Esta seguro que desea eliminar este registro?');"><button title="Eliminar" type="button" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button></a>
					</td>
				</tr>
			<?php endforeach;?>
		<?php } else{ ?>
