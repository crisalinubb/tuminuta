...
<form action="<?php echo base_url(); ?>detalle_codigo/buscar_recetas" method="post" class="form-horizontal">
  <fieldset>
    ...
    <div class="form-group">
         <input type="hidden" id="codigo" name="codigo" class="form-control validate[required]" value="<?php echo $codigo_detalle; ?>" />
    </div>
    <div class="text-box">
      ...
      <?php foreach($datos as $recetas): ?>
        <tr>
          ...
          <td class="editar">
            ...
            <a href="<?php echo base_url(); ?>detalle_codigo/agregar_receta_detallecodigo/<?php echo $recetas->id_receta; ?>/<?php echo $codigo_detalle; ?>">
