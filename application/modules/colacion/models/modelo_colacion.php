<?php
class Modelo_Colacion extends CI_Model {
	private $tabla;
	private $prefijo;
	...
	public function getLastId(){
		$this->db->select_max("id_colacion","maximo");
    ...
    public function eliminar($codigo){
    	$this->db->where('id_colacion', $codigo);
    ...
    public function activar($id_colacion){
		$this->db->set('estado', 0);
		$this->db->where('id_colacion', $id_colacion);
		$this->db->update($this->tabla); 
	}

	public function desactivar($id_colacion){
