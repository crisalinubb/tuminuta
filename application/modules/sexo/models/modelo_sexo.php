<?php
class Modelo_Sexo extends CI_Model {
	private $tabla;
	private $prefijo;
	...
	public function getLastId(){
		$this->db->select_max("id_sexo","maximo");
    ...
    public function eliminar($codigo){
    	$this->db->where('id_sexo', $codigo);
		$this->db->delete($this->tabla);
    }

    public function obtenerSexo($nombre_sexo){
    	$this->db->select('*');
    	$this->db->from($this->tabla);
    	$this->db->like('sexo_nombre',$nombre_sexo);
    	$result = $this->db->get();
