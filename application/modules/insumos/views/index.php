    ...
    <tbody class="table-hover">
		<?php if($datos){ ?>
          ...
          <td><?php echo $insumos->factor_costo;?></td>
            ...
            <a href="<?php echo base_url(); ?>insumos/eliminar/<?php echo $insumos->id_insumo; ?>" onclick="return confirm('Esta seguro que desea eliminar este registro?');"><button title="Eliminar" type="button" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button></a>

            <a href="<?php echo base_url(); ?>aporte_insumo/index?insumo=<?php echo $insumos->id_insumo; ?>">
