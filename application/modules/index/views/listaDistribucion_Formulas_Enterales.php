<ol class="breadcrumb">
  ...
  <li class="active">Listado de Distribucion Formulas Enterales</li>
</ol>

<div class="page-header">
  <div class="row">
    <h1 class="col-md-7">Listado de Distribucion Formulas Enterales</h1>
    <div class="col-md-3" style="margin-top:24px;">
    
      <form class="form-inline" method="post" action="<?php echo base_url(); ?>index/busquedaPorServicio_Formulas_Enterales">
