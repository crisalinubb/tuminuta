    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">
        <select id="codigo_unidadcompra" name="codigo_unidadcompra" class="selectpicker validate[required]" data-live-search="true">
           ...
           <?php if($unidades_medidas){ ?>
           <?php foreach($unidades_medidas as $unidades_medida){ ?>
              <option value="<?php echo $unidades_medida->id_unidad_medidad; ?>"  <?php if($insumos->unidad_compra == $unidades_medida->id_unidad_medidad) echo "selected"; ?>><?php echo $unidades_medida->nombre; ?></option>
           <?php } ?>
           <?php } ?>
        </select>
      </div>
