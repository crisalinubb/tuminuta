<?php
class Modelo_Medico extends CI_Model {
	private $tabla;
	private $prefijo;
	...
	public function getLastId(){
		$this->db->select_max("id_medico","maximo");
    ...
    public function eliminar($codigo){
    	$this->db->where('id_medico', $codigo);
		$this->db->delete($this->tabla);
    }

    public function obtenerMedico($nombre_medico){
    	$this->db->select('*');
    	$this->db->from($this->tabla);
    	$this->db->like('medico_nombre',$nombre_medico);
    	$result = $this->db->get();
