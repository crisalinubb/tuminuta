<?php
class Modelo_serviciosalimentacion extends CI_Model {
	private $tabla;
	private $prefijo;
	
	function __construct(){
		$this->tabla = "servicio_alimentacion";
		parent::__construct();
	}

	public function getLastId(){
		$this->db->select_max("id_servicio_alimentacion","maximo");
    ...
    public function eliminar($codigo){
    	$this->db->where('id_servicio_alimentacion', $codigo);
