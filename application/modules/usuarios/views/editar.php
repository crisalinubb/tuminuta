      ...
      <div class="col-sm-4">
        <select id="unidad" name="unidad" class="form-control validate[required]" data-live-search="true">
           ...
           <?php foreach($unidades as $unidad){ ?>
              <option value="<?php echo $unidad->id_hospital; ?>" <?php if($unidad->id_hospital == $usuarios->id_unidad) echo "selected"; ?>><?php echo $unidad->hos_nombre; ?></option>
           <?php } ?>
           <?php } ?>
        </select>
      </div>
      ...
      <div class="col-sm-4">
        <select id="perfil" name="perfil" class="form-control validate[required]" data-live-search="true">
           ...
           <?php foreach($perfiles as $perfil){ ?>
              <option value="<?php echo $perfil->id_perfil; ?>" <?php if($perfil->id_perfil == $usuarios->id_perfil) echo "selected"; ?>><?php echo $perfil->perfil_nombre; ?></option>
           <?php } ?>
           <?php } ?>
        </select>
      </div>
