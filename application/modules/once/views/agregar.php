...
<form action="<?php echo base_url(); ?>once/buscar_recetas" method="post" class="form-horizontal">
  <fieldset>
      ...
      <?php foreach($datos as $recetas): ?>
        <tr>
          ...
          <td class="editar">
            ...
            <a href="<?php echo base_url(); ?>once/agregar_receta/<?php echo $recetas->id_receta; ?>">
