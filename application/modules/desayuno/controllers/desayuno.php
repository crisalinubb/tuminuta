...
class Desayuno extends CI_Controller {
	...
	public function activar($id_desayuno = false){
		$this->objDesayuno->activar($id_desayuno);
	...
	public function desactivar($id_desayuno = false){
		$this->objDesayuno->desactivar($id_desayuno);
