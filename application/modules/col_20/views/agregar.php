<div class="page-header">
  <h1>Agregar Colacion de las 20</h1>
</div>
<form action="<?php echo base_url(); ?>col_20/buscar_recetas" method="post" class="form-horizontal">
  <fieldset>
      ...
      <?php foreach($datos as $recetas): ?>
        <tr>
          ...
          <td class="editar">
            ...
            <a href="<?php echo base_url(); ?>col_20/agregar_receta/<?php echo $recetas->id_receta; ?>">
