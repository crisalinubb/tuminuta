...
<div class="page-header">
  ...
  <?php echo strftime("%A, %d de %B de %Y, %H:%M:%S", strtotime(date("Y-m-d H:i:s"))); ?>
	...
	<div class="btn-group btn-group-lg" role="group">
		<button class="button button2"><a href="<?php echo base_url(); ?>planificacion/"><i class="icon-calendar" style="font-size:60px;color:black;"> Planificacion</i></a></button> 

		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

		<button class="button button2"><a href="<?php echo base_url(); ?>index/migracion_datos"><i class="icon-exchange" style="font-size:60px;color:black;"> Migracion</i></a></button> 
		
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

		<button class="button button2"><a href="<?php echo base_url(); ?>index/liberar_clinica"><i class="icon-trash" style="font-size:60px;color:black;"> Liberar<br>Clinica</i></a></button>
	</div>
	...
	<div class="btn-group btn-group-lg" role="group">
		<button class="button button2"><a href="<?php echo base_url(); ?>usuarios/"><i class="fa fa-user-o" style="font-size:60px;color:black;"> Usuarios</i></a></button> 

		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

		<button class="button button2"><a href="<?php echo base_url(); ?>index/mostrar_usuarios"><i class="fa fa-user-plus" style="font-size:60px;color:black;"> Asignar Servicios</i></a></button>
	</div>
