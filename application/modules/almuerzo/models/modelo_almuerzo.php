<?php
class Modelo_Almuerzo extends CI_Model {
	private $tabla;
	private $prefijo;
	...
	public function getLastId(){
		$this->db->select_max("id_almuerzo","maximo");
    ...
    public function eliminar($codigo){
    	$this->db->where('id_almuerzo', $codigo);
		$this->db->delete($this->tabla);
    }

    public function obtenerAlmuerzo($nombre_almuerzo){
    	$this->db->select('*');
    	$this->db->from($this->tabla);
    	$this->db->like('receta_nombre',$nombre_almuerzo);
    	$result = $this->db->get();
