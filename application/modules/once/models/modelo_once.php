<?php
class Modelo_Once extends CI_Model {
	private $tabla;
	private $prefijo;
	...
	public function getLastId(){
		$this->db->select_max("id_once","maximo");
    ...
    public function eliminar($codigo){
    	$this->db->where('id_once', $codigo);
		$this->db->delete($this->tabla);
    }

    public function obtenerOnce($nombre_once){
    	$this->db->select('*');
    	$this->db->from($this->tabla);
    	$this->db->like('receta_nombre',$nombre_once);
    	$result = $this->db->get();
