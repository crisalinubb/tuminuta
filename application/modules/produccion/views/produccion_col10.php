<ol class="breadcrumb">
  ...
  <li><a href="<?php echo base_url(); ?>produccion/vista_produccion_col10">Produccion Col-10</a></li>
  <li class="active">Informe Produccion Colacion de las 10</li>
</ol>
...
<div class="thumbnail table-responsive all-responsive" id="multiselectForm">
  ...
  <?php $costo_receta = $this->objInsumoreceta->costo_receta($col10->id_receta); ?>

  <h4><center><strong><?php echo $col10->Producto; ?></strong></center></h4>
  <p align="right">Volumen: <?php echo $col10->total; ?></p>

  <?php $costo_total_receta = $costo_receta->SubTotal*$col10->total;
        $costo_total_col10 = $costo_total_col10+$costo_total_receta;
  ?>
...
<div>
   <p align="center"><strong>Costo Total Colacion 10: $<?php echo number_format($costo_total_col10, 2, ',', '');?></strong></p>
</div>
