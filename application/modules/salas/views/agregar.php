...
<form id="form-agregar" name="form-agregar" method="post" class="form-horizontal">
  <fieldset>
    ...
    <div class="form-group">
      <label for="tipo" class="col-sm-2 control-label">Servicios Clinicos</label>
      <div class="col-sm-4">
        <select id="servicio_clinico" name="servicio_clinico" class="form-control validate[required]" data-live-search="true">
