<ol class="breadcrumb">
  ...
  <li class="active">Eliminar Planificacion</li>
</ol>

<div class="page-header">
  <div class="row">
    <h1 class="col-md-7">Eliminar Planificacion</h1>
  </div>
</div>
<form action="<?php echo base_url(); ?>planificacion/eliminar_planificacion" method="post" class="form-horizontal">
