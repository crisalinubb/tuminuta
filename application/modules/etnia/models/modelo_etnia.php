<?php
class Modelo_Etnia extends CI_Model {
	private $tabla;
	private $prefijo;
	...
	public function getLastId(){
		$this->db->select_max("id_etnia","maximo");
    ...
    public function eliminar($codigo){
    	$this->db->where('id_etnia', $codigo);
		$this->db->delete($this->tabla);
    }

    public function obtenerEtnia($nombre_etnia){
    	$this->db->select('*');
    	$this->db->from($this->tabla);
    	$this->db->like('etnia_nombre',$nombre_etnia);
    	$result = $this->db->get();
