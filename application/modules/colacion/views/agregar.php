<div class="page-header">
  <h1>Agregar Colacion</h1>
</div>
<form action="<?php echo base_url(); ?>colacion/buscar_recetas" method="post" class="form-horizontal">
  <fieldset>
      ...
      <?php foreach($datos as $recetas): ?>
        <tr>
          ...
          <td class="editar">
            ...
            <a href="<?php echo base_url(); ?>colacion/agregar_receta/<?php echo $recetas->id_receta; ?>">
