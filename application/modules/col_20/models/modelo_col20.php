<?php
class Modelo_Col20 extends CI_Model {
	private $tabla;
	private $prefijo;
	...
	public function getLastId(){
		$this->db->select_max("id_col20","maximo");
    ...
    public function eliminar($codigo){
    	$this->db->where('id_col20', $codigo);
		$this->db->delete($this->tabla);
    }

    public function obtenerCol20($nombre_col20){
    	$this->db->select('*');
    	$this->db->from($this->tabla);
    	$this->db->like('receta_nombre',$nombre_col20);
    	$result = $this->db->get();
