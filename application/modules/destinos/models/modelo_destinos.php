<?php
class Modelo_Destinos extends CI_Model {
	private $tabla;
	private $prefijo;
	...
	public function getLastId(){
		$this->db->select_max("id_destino","maximo");
    ...
    public function eliminar($codigo){
    	$this->db->where('id_destino', $codigo);
		$this->db->delete($this->tabla);
    }

    public function obtenerDestino($nombre_destino){
    	$this->db->select('*');
    	$this->db->from($this->tabla);
    	$this->db->like('nombre',$nombre_destino);
    	$result = $this->db->get();
